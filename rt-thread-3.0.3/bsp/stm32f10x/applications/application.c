...
//GSM thread 
    GSM_thread =  rt_thread_create("GSM_thread",
 ...
 //Boot thread 
    Booth_thread =  rt_thread_create("Booth_thread",
                                   Booth_Thread_enter, RT_NULL,
                                   512, 8, 20);
	if (Booth_thread != RT_NULL)
        rt_thread_startup(Booth_thread);
